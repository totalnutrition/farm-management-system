-- =====================================================================
-- FarmInsight consolidated migration
-- =====================================================================
-- Apply this single file in the Supabase SQL editor (or psql) to bring
-- a database from the post-PR #9 state (migrations 0001-0003 applied)
-- up to current master.
--
-- Covers migrations 0004 through 0015 in order. All statements are
-- idempotent: re-running this file on a database that's already at
-- current is safe.
-- =====================================================================
